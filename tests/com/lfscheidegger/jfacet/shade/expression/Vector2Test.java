...
public class Vector2Test {
  ...
  private void testAddCommon(Vector2 added, Vector2.Primitive expected) {
    ...
    Operator op = ((BinaryOperationEvaluator)added.getEvaluator()).mOperator;
  ...
  public void testSubCommon(Vector2 subtracted, Vector2.Primitive expected) {
    ...
    Operator op = ((BinaryOperationEvaluator)subtracted.getEvaluator()).mOperator;
    assertEquals(op.getOperatorSymbol(), "-");
  }
  ...
  private void testMulCommon(Vector2 multiplied, Vector2.Primitive expected) {
    ...
    Operator op = ((BinaryOperationEvaluator)multiplied.getEvaluator()).mOperator;
    assertEquals(op.getOperatorSymbol(), "*");
  }
  ...
  private void testDivCommon(Vector2 divided, Vector2.Primitive expected) {
    ...
    Operator op = ((BinaryOperationEvaluator)divided.getEvaluator()).mOperator;
    assertEquals(op.getOperatorSymbol(), "/");
  }
  ...
  public void testDot() {
    ...
    assertEquals(evaluator.mFunctionName, "dot");
    assertEquals(evaluator.mType, Type.FLOAT_T);
  ...
  public void testNormalize() {
    ...
    assertEquals(evaluator.mFunctionName, "normalize");
    assertEquals(evaluator.mType, Type.VEC2_T);
  ...
  public void testLength() {
    ...
    assertEquals(evaluator.mFunctionName, "length");
    assertEquals(evaluator.mType, Type.FLOAT_T);
  }
