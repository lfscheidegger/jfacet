...
public class Vec2ExpTest {
  ...
  public void testConstructors() {
    ...
    assertEquals(Shade.vec(new FloatExpression(1), 2).evaluate(), new Vector(1, 2));
    assertEquals(Shade.vec(1, new FloatExpression(2)).evaluate(), new Vector(1, 2));
    assertEquals(Shade.vec(new FloatExpression(1), new FloatExpression(2)).evaluate(), new Vector(1, 2));
  }
