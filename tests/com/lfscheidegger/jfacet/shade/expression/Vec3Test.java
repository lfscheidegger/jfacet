...
public class Vec3Test {
  ...
  private final Vec3 mVec = new Vec3(1, 2, 3);
  ...
  public void testConstructors() {
    ...
    vec = new Vec3(ImmutableList.<Expression>of(x, y, z), NodeType.CONS);

    assertEquals(vec.getNodeType(), NodeType.CONS);
    assertEquals(vec.getParents(), ImmutableList.of(x, y, z));

    vec = new Vec3(new VertexDataBuffer(new float[] {0, 0, 1, 0, 1, 1}, 2));
  ...
  public void testNormalize() {
    Vec3 normalized = mVec.normalize();
  ...
  public void testIsLessThan() {
    Vec3 rhs = new Vec3(1, 2, 3);
    BVec3 lessThan = mVec.isLessThan(rhs);
  ...
  public void testIsLessThanOrEqual() {
    Vec3 rhs = new Vec3(1, 2, 3);
    BVec3 lessThanOrEqual = mVec.isLessThanOrEqual(rhs);
  ...
  public void testIsGreaterThan() {
    Vec3 rhs = new Vec3(1, 2, 3);
    BVec3 greaterThan = mVec.isGreaterThan(rhs);
  ...
  public void testIsGreaterThanOrEqual() {
    Vec3 rhs = new Vec3(1, 2, 3);
    BVec3 greaterThanOrEqual = mVec.isGreaterThanOrEqual(rhs);
  ...
  public void testIsEqualComponentwise() {
    Vec3 rhs = new Vec3(1, 2, 3);
    BVec3 equalComponentwise = mVec.isEqualComponentwise(rhs);
  ...
  public void testIsNotEqualComponentwise() {
    Vec3 rhs = new Vec3(1, 2, 3);
    BVec3 notEqualComponentwise = mVec.isNotEqualComponentwise(rhs);
