...
public class FloatEvaluatorsTest {
  ...
  public void testForVec2Dot() {
    assertTrue(Shade.dot(new Vector(1, 2), new Vector(3, 4)).evaluate() == 11);
  ...
  public void testForVec3Dot() {
    assertTrue(Shade.dot(new Vector(1, 2, 3), new Vector(4, 5, 6)).evaluate() == 32);
  ...
  public void testForVec4Dot() {
    assertTrue(Shade.dot(new Vector(1, 2, 3, 4), new Vector(1, 2, 3, 4)).evaluate() == 30);
