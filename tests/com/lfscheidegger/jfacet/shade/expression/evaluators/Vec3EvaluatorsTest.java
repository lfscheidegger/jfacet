...
public class Vec3EvaluatorsTest {
  ...
  public void testForNegation() {
    ...
    assertEquals(eval.evaluate(Shade.neg(Shade.vec(1, 2, 3))), new Vector(1, 2, 3).neg());
  }

  @Test
  public void testForCross() {
    assertEquals(Shade.cross(Shade.vec(1, 0, 0), Shade.vec(0, 1, 0)).evaluate(), new Vector(0, 0, 1));
