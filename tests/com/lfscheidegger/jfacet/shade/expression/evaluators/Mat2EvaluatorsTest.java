...
public class Mat2EvaluatorsTest {
  ...
  public void testForAdditionWithFloat() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.add(Shade.mat(new Matrix(2)), 3), mContext),
  ...
  public void testForSubtractionWithFloat() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.sub(Shade.mat(new Matrix(2)), 3), mContext),
        "mat2(mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))) - float(3.0))");
  }
  ...
  public void testForMultiplicationWithFloat() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.mul(Shade.mat(new Matrix(2)), 3), mContext),
        "mat2(mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))) * float(3.0))");
  }
  ...
  public void testForDivisionWithFloat() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.div(Shade.mat(new Matrix(2)), 3), mContext),
        "mat2(mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))) / float(3.0))");
  }
  ...
  public void testForAdditionWithMatrix() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.add(new Matrix(2), new Matrix(2)), mContext),
  ...
  public void testForSubtractionWithMatrix() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.sub(new Matrix(2), new Matrix(2)), mContext),
        "mat2(mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))) - mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))))");
  }
  ...
  public void testForMultiplicationWithMatrix() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.mul(new Matrix(2), new Matrix(2)), mContext),
        "mat2(mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))) * mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))))");
  }
  ...
  public void testForDivisionWithMatrix() {
    ...
    assertEquals(
        eval.getGlSlString(Shade.div(new Matrix(2), new Matrix(2)), mContext),
        "mat2(mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))) / mat2(vec2(float(1.0), float(0.0)), vec2(float(0.0), float(1.0))))");
  }
  ...
  public void testForNegation() {
    ...
    assertEquals(eval.evaluate(Shade.neg(Shade.mat(new Matrix(2)))), new Matrix(2).neg());
  }
  ...
  public void testForMultiplicationWithVector() {
    ...
    assertEquals(eval.evaluate(Shade.mul(Shade.mat(new Matrix(2).mul(2)), Shade.vec(1, 1))), new Vector(2, 2));
  }
}
